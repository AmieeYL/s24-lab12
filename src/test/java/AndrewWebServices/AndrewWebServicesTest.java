...
public class AndrewWebServicesTest {
    ...
    public void testLogIn() {
        ...
        assertTrue("Login should be successful for correct credentials", 
    ...
    public void testGetRecommendation() {
        ...
        assertEquals("Expected recommendation does not match", "Animal House", andrewWebService.getRecommendation("Scotty"));
    }
